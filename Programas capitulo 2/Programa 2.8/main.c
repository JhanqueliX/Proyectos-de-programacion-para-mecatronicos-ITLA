...
/*Asistentes.
Elprograma, al recibir como datos la matricula, la carrera el semestre y el promedio de un estudiante de universidad privada, determina si este se puede ser asistente de su carrera.
