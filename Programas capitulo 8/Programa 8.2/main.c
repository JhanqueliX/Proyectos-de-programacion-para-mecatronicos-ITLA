...
void main(void)
{
    printf("El programa muestra la manera en que se declara una estructura,\nasi como la forma en que se tiene acceso a los campos\nde los apuntadores de tipo estructura tanto para lectura comopara escritura.\n Se utiliza ademas una funcion que\nrecibe como parámetro un apuntador de tipo estructura.");
